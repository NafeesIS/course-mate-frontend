  ...
  return (
    <TooltipProvider>
      <Tooltip open={isOpen} onOpenChange={setIsOpen}>
        ...
        {/* {isOpen && ( */}
        <TooltipContent className='tooltip-content flex h-full max-h-96 w-full max-w-60 translate-y-2 flex-wrap whitespace-pre-wrap bg-transparent'>
...
export default SatisfiedChargeTooltip;
