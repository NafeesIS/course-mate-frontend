    ...
    <div className=''>
      <div className='wrapper mb-20 mt-12 py-8 md:py-12 lg:py-16'>
        ...
        <div className='mx-auto flex max-w-[300px] gap-16 overflow-hidden md:grid md:max-w-full md:grid-cols-3 md:gap-6 lg:gap-14'>
          ...
          >
            ...
            <div className='flex items-center justify-start gap-4'>
              <div className='relative w-fit'>
                <p className='text-base font-medium'>₹14,999</p>
            ...
            <Separator /> */}
            <GetStartedDialog buttonClassName='mt-4 w-full px-8' />
            <div className=' mt-4'>
          ...
          <div
            className={`min-w-[300px] max-w-[300px] rounded-lg border bg-background bg-gradient-to-b from-[#0076CE52] via-[#0076CE29] to-[#FFFFFF00] px-3 py-5 shadow-lg duration-200 md:min-w-0 md:max-w-full lg:px-5 lg:py-6 ${selectedPlan === 'Standard' ? '-translate-x-[364px] md:-translate-x-0' : ` ${selectedPlan === 'Elite' ? '-translate-x-[768px] md:translate-x-0' : 'translate-x-full md:translate-x-0'}`}`}
          >
            <p className='mb-2 text-start text-lg font-semibold lg:mb-4'>
              Standard
            </p>
            <p className='text-muted-foreground-darker mb-2 text-start text-xs lg:text-sm'>
              Ideal for handling the mandatory annual compliance + GST
              compliance
            </p>
            <div className='flex items-center justify-start gap-4'>
              <div className='relative w-fit'>
                <p className='text-base font-medium'>₹49,999</p>
                <div className='absolute top-[9px] w-full translate-y-[-40%] rotate-[-16deg] border-b-[1px] border-[#E83E3E] md:top-[11px]'></div>
              </div>
              <p className='flex items-center justify-center gap-1 rounded-full bg-[#ECF8EB] px-2 py-0.5'>
                <CiDiscount1 className='text-xs' fill='#3EB837' />{' '}
            ...
            <Separator /> */}
            <GetStartedDialog buttonClassName='mt-4 w-full bg-gradient-to-r from-blue-500 via-blue-600 to-purple-600 px-8 py-3' />
            <div className=' mt-4'>
              <p className='mb-3 text-lg font-semibold'>What you will get</p>
              <div className='flex flex-col items-start justify-start gap-3'>
                ...
                <p className='flex items-center justify-start gap-2'>
                  <AiOutlineCheck fill='#3EB837' className='min-w-5 max-w-5' />{' '}
                  <span className='text-xs lg:text-sm'>GST Registration</span>
                </p>
              </div>
            </div>
          </div>
          <div
            className={`min-w-[300px] max-w-[300px] rounded-lg border bg-white px-3 py-5 shadow-lg duration-200 md:min-w-0 md:max-w-full lg:px-5 lg:py-6 ${selectedPlan === 'Elite' ? '-translate-x-[728px] md:-translate-x-0' : 'translate-x-full md:translate-x-0'}`}
          >
            <p className='mb-2 text-start text-lg font-semibold lg:mb-4'>
              Elite
            </p>
            <p className='text-muted-foreground-darker mb-2 text-start text-xs lg:text-sm'>
              Comprehensive package that covers company annual, GST & statutory
              compliance
            </p>
            <div className='flex items-center justify-start gap-4'>
              <div className='relative w-fit'>
                <p className='text-base font-medium'>₹69,999</p>
                <div className='absolute top-[9px] w-full translate-y-[-40%] rotate-[-16deg] border-b-[1px] border-[#E83E3E] md:top-[11px]'></div>
              </div>
              <p className='flex items-center justify-center gap-1 rounded-full bg-[#ECF8EB] px-2 py-0.5'>
                <CiDiscount1 className='text-xs' fill='#3EB837' />{' '}
            ...
            <div className=' mt-4'>
              ...
              <div className='flex flex-col items-start justify-start gap-3'>
                <p className='flex items-center justify-start gap-2 font-semibold'>
                  <AiOutlineCheck fill='#3EB837' className='min-w-5 max-w-5' />{' '}
                  <span className='text-xs lg:text-sm'>
                    Includes everything from the Starter and Standard Package
                  </span>
                </p>
                <p className='flex items-center justify-start gap-2'>
                  <AiOutlineCheck fill='#3EB837' className='min-w-5 max-w-5' />{' '}
...
export default AnnualPvtPricing;
