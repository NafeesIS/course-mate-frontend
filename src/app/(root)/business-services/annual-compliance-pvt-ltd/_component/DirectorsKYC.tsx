  ...
  return (
    <div className='wrapper mb-20 mt-16 text-center'>
      <h2 className='mx-auto mb-6 px-4 text-center text-2xl font-bold leading-snug md:text-3xl md:leading-snug'>
        Due date for{' '}
        <span className='italic text-primary'>Directors KYC for FY 23-24</span>
      </h2>
      <div className='mb-6 pl-4'>
        <ul className='text-muted-foreground-darker list-disc space-y-2 text-start text-xs lg:text-sm'>
          <li>
            As per the Companies Act, 2013, every Director holding a Director
            Identification Number (DIN) must complete the KYC (Know Your
            Customer) process annually by filing Form DIR-3 KYC or Web KYC.
          </li>
          <li>
            This ensures that the Director’s details, such as address, email,
            and contact information, are updated with the Ministry of Corporate
            Affairs (MCA).
          </li>
        </ul>
      </div>
      ...
      <div className='-pl-5 text-muted-foreground-darker mt-6 flex items-start justify-start gap-1 text-start text-xs lg:text-sm'>
        <Image className='size-6' src={light} alt='light' />
        <span>
          If the Director fails to file Form DIR-3KYC or Web KYC before the due
          date, he will be liable for a penalty of{' '}
