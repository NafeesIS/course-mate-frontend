              ...
              <div className='max-w-56 md:max-w-60 lg:max-w-72'>
                ...
                <ul className='text-muted-foreground-darker mt-4 list-inside list-disc text-xs font-normal lg:text-sm'>
                  <li>
                    ...
                    stamp duty, CRC will check the forms and if any error is
                    found in incorporation forms{' '}
                    <span className='font-semibold'>
                      CRC will guide and this will be subjected to resubmission.
                    </span>{' '}
                  </li>
                  <li>
                    Company have to make the necessary corrections in
                    resubmissions and re-submit the form.
                  </li>
                </ul>
              </div>
              <div className='max-w-56 md:ml-4 md:max-w-60 lg:ml-14 lg:max-w-72'>
                ...
                <ul className='text-muted-foreground-darker mt-4 list-inside list-disc text-xs font-normal lg:text-sm'>
                  ...
                  <ol className='mt-3 list-inside list-decimal'>
                    ...
                    <li>Corporate Identification No (CIN)</li>
                    <li>PAN</li>
                    <li>TAN</li>
                  </ol>
                </ul>
