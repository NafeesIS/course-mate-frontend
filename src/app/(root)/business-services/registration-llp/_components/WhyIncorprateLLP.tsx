...
import { WhyIncorporateLLPData } from '../_data/data';

const WhyIncorporateLLP = () => {
  return (
    <div className='wrapper mb-20 mt-16 text-center'>
      ...
      <div className='mt-8 grid w-full grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-2 lg:mt-12 xl:gap-5'>
        {WhyIncorporateLLPData.map((benefit, index) => (
...
export default WhyIncorporateLLP;
