...
const DateInput: React.FC<DateInputProps> = ({
  ...
  return (
    <div
      className={cn(
        'flex items-center rounded-lg border px-1 text-sm',
        className
      )}
    >
      <Input
        ...
        className='w-6 border-none p-0 text-center text-xs outline-none md:w-7'
        placeholder='D'
      />
      ...
      <Input
        ...
        className='w-5 border-none p-0 text-center text-xs outline-none md:w-6'
        placeholder='M'
      />
      <span className='-mx-px opacity-20'>/</span>
      <Input
        ...
        className='w-10 border-none p-0 text-center text-xs outline-none md:w-12'
        placeholder='YYYY'
      />
    </div>
  );
